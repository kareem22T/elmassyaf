...
export default function AllUnits() {
    ...
    const {city_id, compound_id, rooms_number, search_text} = useRoute().params;
    ...
    const fetchHome = async () => {
        setLoading(true);
        try {
            const response = await axiosInstance.get(`${API_URL}/api/user/home/filter?city_id=${city_id || ''}&compounds_id=${compound_id || ''}&search=${search_text}`);
        ...
        <SafeAreaProvider>
            ...
            <SafeAreaView style={styles.container}>
                <View style={styles.header}>
                    ...
                    <Text style={styles.headerTitle} bold>نتائج البحث</Text>
